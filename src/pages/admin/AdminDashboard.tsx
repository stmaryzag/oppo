...
import { 
  ...
  ArrowUpDown, Eye, ExternalLink, ShieldCheck, Layers, BookOpen, HelpCircle
} from 'lucide-react';
...
export const AdminDashboard = () => {
  ...
  const sections = [
    {
      title: 'إدارة مجموعات الخوارس وتعيين المسؤولين',
      desc: 'فصل وتخصيص كل خورس وتعيين أدمن الخورس والخدام المخصصين لكل خورس',
      icon: Layers,
      color: 'bg-violet-600',
      badge: 'الخورسات المتعددة',
      path: '/admin/groups'
    },
    {
      title: 'لوحة تحكم أدمن الخورس (معاينة وتخصيص الخوارس)',
      desc: 'الدخول كأدمن خورس متخصص والاطلاع على تفاصيل الخورس وشمامسته وامتحاناته واشتراكاته',
      icon: Crown,
      color: 'bg-purple-600',
      badge: 'أدمن الخورس',
      path: '/admin/chorus'
    ...
    {
      title: 'مناهج الألحان والطقوس والملفات التعليمية',
      desc: 'إدارة الملفات الصوتية، الهزات، ملفات PDF، وتصنيف المواد حسب الخورس',
      icon: BookOpen,
      color: 'bg-emerald-600',
      badge: 'المكتبة التعليمية',
      path: '/study'
    },
    {
      title: 'منصة الاختبارات والمسابقات والتقييم',
      desc: 'إنشاء ومتابعة الامتحانات التفاعلية، التصحيح التلقائي، وإيداع النقاط',
      icon: HelpCircle,
      color: 'bg-purple-600',
      badge: 'الامتحانات التفاعلية',
      path: '/quizzes'
    },
    {
